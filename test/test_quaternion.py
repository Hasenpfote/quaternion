...
class TestQuaternion(TestCase):
    ...
    def test_create_from_self(self):
        expected = quat.Quaternion([1., 2., 3., 4.])
        actual = quat.Quaternion(expected)
    ...
    def test_create_from_invalid_ndarray(self):
        with self.assertRaises(ValueError):
            q = quat.Quaternion(np.array([1., 2., 3., 4., 5]))

    def test_create_from_ndarray_without_copy(self):
        expected = np.array([1., 2., 3., 4.])
        actual = quat.Quaternion(expected, copy=False)
        self.assertTrue(np.allclose(actual._components, expected))
        self.assertTrue(id(actual._components) == id(expected))
    ...
    def test_add(self):
        ...
        actual = quat.Quaternion([1., 2., 3., 4.]) + quat.Quaternion([2., 3., 4., 5.])
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_iadd(self):
        expected = np.array([3., 5., 7., 9.])
        actual = quat.Quaternion([1., 2., 3., 4.])
        components_id = id(actual._components)
        actual += quat.Quaternion([2., 3., 4., 5.])
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_sub(self):
        ...
        actual = quat.Quaternion([2., 3., 4., 5.]) - quat.Quaternion([1., 2., 3., 4.])
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_mul_with_scalar(self):
        ...
        actual = quat.Quaternion([1., 2., 3., 4.]) * 2.
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_rmul(self):
        expected = np.array([2., 4., 6., 8.])
        actual = 2. * quat.Quaternion([1., 2., 3., 4.])
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_div(self):
        expected = np.array([1., 2., 3., 4.])
        actual = quat.Quaternion([2., 4., 6., 8.]) / 2.
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_idiv(self):
        expected = np.array([1., 2., 3., 4.])
        actual = quat.Quaternion([2., 4., 6., 8.])
        components_id = id(actual._components)
        actual /= 2.
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_parts(self):
        ...
        self.assertTrue(np.isclose(s, expected[quat.Quaternion._SCALAR_PART]))
        self.assertTrue(np.allclose(v, expected[quat.Quaternion._VECTOR_PART]))
    ...
    def test_is_zero(self):
        ...
        q = quat.Quaternion([0., 0., 0., 1.])
        self.assertFalse(q.is_zero())

    def test_is_identity(self):
        q = quat.Quaternion([1., 0., 0., 0.])
        ret = q.is_identity()
        self.assertTrue(isinstance(ret, bool))
        self.assertTrue(ret)
    ...
    def test_is_real(self):
        ...
        q = quat.Quaternion([0., 2., 3., 4.])
        self.assertFalse(q.is_real())

    def test_is_pure(self):
        q = quat.Quaternion([0., 1., 2., 3.])
        ret = q.is_pure()
        self.assertTrue(isinstance(ret, np.bool_))
        self.assertTrue(ret)
    ...
    def test_norm_squared(self):
        expected = 4.
        actual = quat.Quaternion([1., 1., 1., 1.]).norm_squared()
        self.assertTrue(np.isclose(actual, expected))

    def test_norm(self):
        expected = 2.
        actual = quat.Quaternion([1., 1., 1., 1.]).norm()
        self.assertTrue(np.isclose(actual, expected))

    def test_to_axis_angle(self):
        expected = np.array([1., 0., 0.]), 1.047197551196598
        q = quat.Quaternion([8.660254037844387e-001, 4.999999999999999e-001, 0., 0.])  # axis=[1,0,0] deg=60
    ...
    def test_to_rotation_matrix(self):
        ...
        expected[1, 1:3] = c, s
        expected[2, 1:3] = -s, c
        q = quat.Quaternion([0.8660254037844387, 0.5, 0., 0.])  # axis=[1,0,0] deg=60
    ...
    def test_equals(self):
        q1 = quat.Quaternion([1., 2., 3., 4.])
        q2 = quat.Quaternion([1., 2., 3., 4.])
        check = quat.Quaternion.equals(q1, q2)
        self.assertTrue(isinstance(check, bool))
        self.assertTrue(check)

        q1 = quat.Quaternion([1000.00, 2000.00, 3000.00, 4000.00])
        q2 = quat.Quaternion([1000.01, 2000.01, 3000.01, 4000.01])
        check = quat.Quaternion.equals(q1, q2)
        self.assertTrue(isinstance(check, bool))
        self.assertTrue(check)

        q2 = quat.Quaternion([1000.10, 2000.10, 3000.10, 4000.10])
        check = quat.Quaternion.equals(q1, q2)
        self.assertTrue(isinstance(check, bool))
    ...
    def test_are_same_rotation(self):
        ...
        q2 = quat.Quaternion([-1., 0., 0., 0.]) # q2 = -q1
        check = quat.Quaternion.are_same_rotation(q1, q2)
        self.assertTrue(isinstance(check, np.bool_))
        self.assertTrue(check)

        q1 = quat.Quaternion([ 0.8660254037844387,  0.5, 0., 0.]) # axis=[ 1,0,0] deg=60
        q2 = quat.Quaternion([-0.8660254037844387, -0.5, 0., 0.]) # axis=[-1,0,0] deg=300
        check = quat.Quaternion.are_same_rotation(q1, q2)
        self.assertTrue(isinstance(check, np.bool_))
        self.assertTrue(check)

        q1 = quat.Quaternion([0.9659258262890683, 0.25881904510252074, 0., 0.]) # axis=[1,0,0] deg=30
        q2 = quat.Quaternion([0.7071067811865476, 0.7071067811865476, 0., 0.]) # axis=[1,0,0] deg=90
        check = quat.Quaternion.are_same_rotation(q1, q2)
        self.assertTrue(isinstance(check, np.bool_))
        self.assertFalse(check)
    ...
    def test_identity(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.identity()
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_inverse(self):
        expected = quat.Quaternion([1., 2., 3., 4.])
        actual = quat.Quaternion.inverse(expected)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertFalse(np.allclose(actual._components, expected._components))
        actual = quat.Quaternion.inverse(actual)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected._components))

    def test_conjugate(self):
        expected = np.array([1., -2., -3., -4.])
        actual = quat.Quaternion.conjugate(quat.Quaternion([1., 2., 3., 4.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_dot(self):
        expected = 4.
        q = quat.Quaternion([1., 1., 1., 1.])
        actual = quat.Quaternion.dot(q, q)
        self.assertTrue(np.isclose(actual, expected))

    def test_ln(self):
        expected = np.array([1.700598690831078, 5.151902926640850e-001, 7.727854389961275e-001, 1.030380585328170])
        actual = quat.Quaternion.ln(quat.Quaternion([1., 2., 3., 4.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_ln_with_identity(self):
        expected = np.array([0., 0., 0., 0.])
        actual = quat.Quaternion.ln(quat.Quaternion([1., 0., 0., 0.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_ln_u(self):
        expected = np.array([-1.110223024625157e-016, 5.151902926640851e-001, 7.727854389961275e-001, 1.030380585328170])
        q = quat.Quaternion([1.825741858350554e-001, 3.651483716701107e-001, 5.477225575051661e-001, 7.302967433402214e-001]) # normalize([1,2,3,4])
        actual = quat.Quaternion.ln_u(q)
        np.allclose(actual._components, expected)

    def test_ln_u_with_identity(self):
        expected = np.array([0., 0., 0., 0.])
        actual = quat.Quaternion.ln_u(quat.Quaternion([1., 0., 0., 0.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_exp(self):
        expected = np.array([1.693922723683299, -7.895596245415587e-001, -1.184339436812338, -1.579119249083117])
        actual = quat.Quaternion.exp(quat.Quaternion([1., 2., 3., 4.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_exp_with_zero(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.exp(quat.Quaternion([0., 0., 0., 0.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_exp_p_with_zero(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.exp_p(quat.Quaternion([0., 0., 0., 0.]))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_pow(self):
        expected = np.array([-28., 4., 6., 8.])
        actual = quat.Quaternion.pow(quat.Quaternion([1., 2., 3., 4.]), 2.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_pow_with_identity(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.pow(quat.Quaternion([1., 0., 0., 0.]), 2.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_pow_u(self):
        expected = np.array([-9.333333333333331e-001, 1.333333333333333e-001, 1.999999999999999e-001, 2.666666666666666e-001])
        actual = quat.Quaternion.pow_u(quat.Quaternion([1.825741858350554e-001, 3.651483716701107e-001, 5.477225575051661e-001, 7.302967433402214e-001]), 2.) # normalize([1,2,3,4])
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_pow_u_with_identity(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.pow_u(quat.Quaternion([1., 0., 0., 0.]), 2.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

    def test_normalize(self):
        c = np.array([1., 2., 3., 4.])
        q = quat.Quaternion.normalize(quat.Quaternion(c))
        self.assertTrue(isinstance(q, quat.Quaternion))
    ...
    def test_from_axis_angle(self):
        ...
        actual = quat.Quaternion.from_axis_angle(np.array([1., 0., 0.]), math.radians(60.))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))

    def test_from_axis_angle_with_identity(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.from_axis_angle(np.array([1., 0., 0.]), 0.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_from_rotation_matrix(self):
        ...
        actual = quat.Quaternion.from_rotation_matrix(m)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_from_rotation_matrix_with_identity(self):
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.from_rotation_matrix(np.identity(3))
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))

    def test_rotate(self):
        expected = np.array([0., 0., 1.])
        q = quat.Quaternion([0.7071067811865476, 0.7071067811865476, 0., 0.])  # axis=[1,0,0] deg=90
        actual = quat.Quaternion.rotate(q, np.array([0., 1., 0.]))
        self.assertTrue(isinstance(actual, np.ndarray))
    ...
    def test_rotate_with_identity(self):
        ...
        actual = quat.Quaternion.rotate(q, np.array([1., 0., 0.]))
        self.assertTrue(isinstance(actual, np.ndarray))
        self.assertTrue(actual.shape, (3,))
        self.assertTrue(np.allclose(actual, expected))
    ...
    def test_rotation_shortest_arc(self):
        ...
        v1 = [1., 0., 0.]
        v2 = [0., 1., 0.]
        actual = quat.Quaternion.rotation_shortest_arc(v1, v2)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_rotational_difference(self):
        ...
        q1 = quat.Quaternion([0.9659258262890683, 0.25881904510252074, 0., 0.]) # axis=[1,0,0] deg=30
        q2 = quat.Quaternion([0.7071067811865476, 0.7071067811865476, 0., 0.]) # axis=[1,0,0] deg=90
        actual = quat.Quaternion.rotational_difference(q1, q2)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_lerp(self):
        ...
        q1 = quat.Quaternion([1., 2., 3., 4.])
        q2 = quat.Quaternion([2., 3., 4., 5.])
        actual = quat.Quaternion.lerp(q1, q2, 0.25)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_lerp_at_boundary(self):
        ...
        expected = np.array([1., 2., 3., 4.])
        actual = quat.Quaternion.lerp(q1, q2, 0.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))

        expected = np.array([2., 3., 4., 5.])
        actual = quat.Quaternion.lerp(q1, q2, 1.)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(np.allclose(actual._components, expected))
    ...
    def test_slerp(self):
        ...
        q1 = quat.Quaternion([1., 0., 0., 0.])  # e.g. axis=[0,0,1] deg=0
        q2 = quat.Quaternion([-0.5, 0., 0., 0.8660254037844387])  # axis=[0,0,1] deg=240
        actual = quat.Quaternion.slerp(q1, q2, 0.25, allow_flip=False)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
        ...
        q1 = quat.Quaternion([1., 0., 0., 0.])  # e.g. axis=[0,0,1] deg=0
        q2 = quat.Quaternion([-0.5, 0., 0., 0.8660254037844387])  # axis=[0,0,1] deg=240
        actual = quat.Quaternion.slerp(q1, q2, 0.25, allow_flip=True)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_slerp_at_boundary(self):
        ...
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.slerp(q1, q2, 0., allow_flip=False)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))

        expected = np.array([-0.5, 0., 0., 0.8660254037844387])
        actual = quat.Quaternion.slerp(q1, q2, 1., allow_flip=False)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
        ...
        expected = np.array([1., 0., 0., 0.])
        actual = quat.Quaternion.slerp(q1, q2, 0., allow_flip=True)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))

        expected = np.array([0.5, 0., 0., -0.8660254037844386]) # expected = -q2
        actual = quat.Quaternion.slerp(q1, q2, 1., allow_flip=True)
        self.assertTrue(isinstance(actual, quat.Quaternion))
        self.assertTrue(self.are_same_rotation(actual._components, expected))
    ...
    def test_squad(self):
        q1 = quat.Quaternion([1., 2., 3., 4.])
        q2 = quat.Quaternion([1., 2., 3., 4.])
        t1 = quat.Quaternion([1., 2., 3., 4.])
        t2 = quat.Quaternion([1., 2., 3., 4.])
        q = quat.Quaternion.squad(q1, q2, t1, t2, 0.5)
        self.assertTrue(isinstance(q, quat.Quaternion))

        self.fail()

    def test_squad_tangent(self):
        p = quat.Quaternion([1., 2., 3., 4.])
        c = quat.Quaternion([1., 2., 3., 4.])
        n = quat.Quaternion([1., 2., 3., 4.])
        q = quat.Quaternion.squad_tangent(p, c, n)
        self.assertTrue(isinstance(q, quat.Quaternion))
    ...
    def test__make_ndarray_by_parts_with_ndarray(self):
        ...
        q = quat.Quaternion._make_ndarray_by_parts(s, v)
        self.assertTrue(isinstance(q, np.ndarray))
        self.assertTrue(np.allclose(q[quat.Quaternion._SCALAR_PART], s))
        self.assertTrue(np.allclose(q[quat.Quaternion._VECTOR_PART], v))
    ...
    def test__multiplication_for_ndarray(self):
        ...
        actual = quat.Quaternion._multiplication_for_ndarray(q, p)
        self.assertTrue(isinstance(actual, np.ndarray))
        self.assertTrue(np.allclose(actual, expected))

        actual = quat.Quaternion._multiplication_for_ndarray(p, q)
        self.assertTrue(isinstance(actual, np.ndarray))
        self.assertTrue(np.allclose(actual, expected))
    ...
    def test__cross_for_ndarray(self):
        ...
        actual = quat.Quaternion._cross_for_ndarray(v1, v2)
        self.assertTrue(isinstance(actual, np.ndarray))
        self.assertTrue(np.allclose(actual, expected))
